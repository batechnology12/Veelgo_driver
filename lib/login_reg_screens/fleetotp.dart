...
import 'fleetDoc.dart';

class FleetOtpVerification extends StatefulWidget {
  final String otp;
  final String phn;

  FleetOtpVerification({Key? key, required this.otp, required this.phn}) : super(key: key);

  @override
  State<FleetOtpVerification> createState() => _FleetOtpVerificationState();
}

class _FleetOtpVerificationState extends State<FleetOtpVerification> {
  ...
  void _verifyAndNavigate() {
    ...
    if (enteredOtp == widget.otp) {
      ...
      Future.delayed(const Duration(seconds: 2), () {
        ...
        SnackbarUtils.showSnackbar(context, 'Fill all the documents');
        Get.to(const FleetDocuments());
      });

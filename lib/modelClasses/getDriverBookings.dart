...
//
//     final driverBookings = driverBookingsFromJson(jsonString);

import 'dart:convert';

DriverBookings driverBookingsFromJson(String str) => DriverBookings.fromJson(json.decode(str));

String driverBookingsToJson(DriverBookings data) => json.encode(data.toJson());

class DriverBookings {
  bool status;
  String message;
  List<Datum> data;
  ...
  factory DriverBookings.fromJson(Map<String, dynamic> json) => DriverBookings(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    vehicleDetails: List<dynamic>.from(json["vehicle_details"].map((x) => x)??{}),

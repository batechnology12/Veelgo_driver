...
//
//     final getLatestBookingModel = getLatestBookingModelFromJson(jsonString);

import 'dart:convert';

GetLatestBookingModel getLatestBookingModelFromJson(String str) =>
    GetLatestBookingModel.fromJson(json.decode(str));

String getLatestBookingModelToJson(GetLatestBookingModel data) =>
    json.encode(data.toJson());

class GetLatestBookingModel {
  bool status;
  String message;
  List<LatestBookingData> data;

  GetLatestBookingModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory GetLatestBookingModel.fromJson(Map<String, dynamic> json) =>
      GetLatestBookingModel(
        status: json["status"],
        message: json["message"],
        data: List<LatestBookingData>.from(
            json["data"].map((x) => LatestBookingData.fromJson(x))),
      );
...
class LatestBookingData {
  ...
  factory LatestBookingData.fromJson(Map<String, dynamic> json) =>
      LatestBookingData(
        id: json["id"],
        ...
        pickupaddress: json["pickup_addreess"] ?? "",
      );

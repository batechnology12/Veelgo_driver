...
class _BankDetailsPageState extends State<BankDetailsPage> {
  final AuthControllers profileController = Get.put(AuthControllers());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (profileController.bankload.value) {
          return const Center(child: CircularProgressIndicator(color: Colors.grey,));
        } else if (profileController.getUserData == null) {
          return const Center(child: Text('No data available.'));
        } else {
          final userDatas = profileController.getUserData!;
          return Column(
            children: [
              Padding(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(userDatas.bankName,style: inter1.copyWith(fontWeight: FontWeight.bold,fontSize: 17,)),
                        ksize20,
                        Text('Account Number',style: inter1.copyWith(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.blueGrey)),
                        Text(userDatas.accountNumber,style: inter1.copyWith(fontWeight: FontWeight.bold,fontSize: 17,)),
                        ksize10,
                      ],
                    ),
                  ),
